...
Description: Spam-free contact form that delivers extensive visitor engagement insight.
Version: 1.3.2
Author: Dropifi
...
function dropifi_admin_js(){  
  wp_enqueue_script( 
		'dropifi_wordpress', 
		'https://s3.amazonaws.com/dropifi/js/widget/dropifi_wordpress.js'
	);
} 
...
function dropifi_widget_js(){  
  wp_enqueue_script( 
		'dropifi_widget', 
		'https://s3.amazonaws.com/dropifi/js/widget/dropifi_widget.wordpress.js'
  );
}
...
<div class="icon32" id="icon-options-general"></div>
    ...
    <h4>Refresh this page after Signup or Login if it does not redirect to the Dropifi dashboard page</h4>
