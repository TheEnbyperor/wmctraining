...
NOTE: All users who have started with a newer version from 2.0.0 and have donated to remove the link to our site, without obtaining the serial number to deactivate the link, please send us through e-mail at info [at] e-xtnd.it the transaction ID of the PayPal, to refund the total amount. After the refund, users can try again. Our system bug is fixed now and working fine so can receive automatically the serial number !
...
8. Assign Forums to WordPress categories
9. Choose the categories where new posts assigned to them will published in phpBB coresponding forum
10. Choose witch author posts will be published in phpBB forums.
