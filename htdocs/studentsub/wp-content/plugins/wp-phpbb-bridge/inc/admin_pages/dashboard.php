                            ...
                            <div id="wpbb_plugin_info" class="postbox ">
                                ...
                                <div class="inside">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php bloginfo('home'); ?>/wp-admin/admin.php?page=wpbb_settings#donate" title="<?php _e('Donate us, get a serial number and remove the backlink', 'wpbb'); ?>">
                                                <?php _e('Remove backlink with donation', 'wpbb'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
