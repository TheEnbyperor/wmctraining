<?php /* Smarty version 2.6.1, created on 2012-01-23 19:02:14
         compiled from chat_display.tpl */ ?>
<?php echo '<?'?>
...
<div align="center"><i><span class="operator"><?php echo $this->_tpl_vars['now_chatting']; ?>
</span></i></div><br />
...
?>
<?php if ($this->_tpl_vars['messages'][$this->_sections['i']['index']]['x'] == 'o'): ?>
<span class="operator"><b><?php echo $this->_tpl_vars['messages'][$this->_sections['i']['index']]['name']; ?>
:</b> <?php echo $this->_tpl_vars['messages'][$this->_sections['i']['index']]['message']; ?>
</span><br />
<?php else: ?>
<span class="guest"><b><?php echo $this->_tpl_vars['messages'][$this->_sections['i']['index']]['name']; ?>
:</b> <?php echo $this->_tpl_vars['messages'][$this->_sections['i']['index']]['message']; ?>
</span><br />
<?php endif; ?>
<?php endfor; endif; ?>
