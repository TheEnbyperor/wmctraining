...
function announcer_admin_sidebar(){
	global $announcer_pluginpath, $announcer_donate_link;
	$txtDomain = 'announcer';
	$plugin_name = 'announcer';
	
	echo "
<div id='sidebar'>
	<div class='donateBt'><a href='$announcer_donate_link' target='_blank'><img src='{$announcer_pluginpath}images/paypalDonateButton.png' alt='Donate' title='" . __('Donate and support this plugin\'s future', $txtDomain) . "'/></a></div>
	<ul class='admSprites'>
		...
		<li><a class='admSpr-donate' href='$announcer_donate_link' target='_blank'>
