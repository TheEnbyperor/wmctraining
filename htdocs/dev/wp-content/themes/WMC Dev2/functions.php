...
add_action('wp_head', 'theme_update_scripts', 0);
add_action('wp_head', 'theme_update_styles');
...
function theme_update_scripts() {
	...
	if (theme_get_option('theme_iclude_scripts_from_cdn')) {
		...
		echo '<!--[if lt IE 9]><script src="' . get_bloginfo('template_url', 'display') . '/html5.js"></script><![endif]-->';
	}
}
