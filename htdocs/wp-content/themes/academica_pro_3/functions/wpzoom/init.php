...
if ( ! defined( 'WPFORMS_SHAREASALE_ID' ) ) {
    define( 'WPFORMS_SHAREASALE_ID', '522049' );
}
 ...
 */
add_filter( 'wpforms_shareasale_id', 'zoom_wpforms_shareasale_id' );
function zoom_wpforms_shareasale_id( $shareasale_id ) {
