    ...
    <nav id="main-navbar" class="main-navbar">
        ...
        <div class="wrapper">
            ...
            <div id="navbar-main">
                ...
                {
                    echo '<p class="wpzoom-notice">Please set your Main Menu on the <a href="'.get_admin_url().'nav-menus.php">Appearance > Menus</a> page. For more information please <a href="https://www.wpzoom.com/documentation/academica-pro-3/">read the documentation</a></p>';
                }
                ?>
