...
'
    ...
    function license_notice()
    {
        ...
        if ( $license_status != 'valid' ) {
            ...
            echo sprintf( __('Your License is <strong>%s</strong>, please %sactivate your product license%s.', 'wpzoom'), $license_status, '<strong><a href="' . $this->get_renewal_link() . '">', '</a></strong>' );
            echo '</div>';
        }
    }
                    ...
                    <form method="post" action="options.php">
                        ...
                        <?php submit_button( 'Save License Key' );
                                ...
                                if ( $license ) {
                                    ...
                                    <?php } else { ?>
                                    <input type="submit" class="button-secondary" name="<?php esc_attr_e($this->theme_slug.'_license_activate'); ?>" value="<?php esc_attr_e( $strings['activate-license'] ); ?>"/>
                                    <?php
                                           }
                                        }
                                      ?>
