...
if ( ! defined( 'THINKUP_UPDATE_THEME_TEXT_DOMAIN' ) ) {
	define( 'THINKUP_UPDATE_THEME_TEXT_DOMAIN', 'alante' );
}
...
// ----------------------------------------------------------------------------------
	...
	// Add Update Notice
	if( file_exists( get_template_directory() . '/lib/update/update_notice_alante.php' ) )
		require_once( get_template_directory() . '/lib/update/update_notice_alante.php');
