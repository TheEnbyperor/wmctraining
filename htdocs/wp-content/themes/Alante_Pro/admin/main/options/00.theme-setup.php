...
function thinkup_theme_register_required_plugins() {
    ...
    $config = array(
        ...
        'message'           => '',
        'strings'           => array(
            'page_title'                                => __( 'Install Required Plugins', 'alante' ),
            'menu_title'                                => __( 'Install Plugins', 'alante' ),
            'installing'                                => __( 'Installing Plugin: %s', 'alante' ),
            'oops'                                      => __( 'Something went wrong with the plugin API.', 'alante' ),
            ...
            'return'                                    => __( 'Return to Required Plugins Installer', 'alante' ),
            'plugin_activated'                          => __( 'Plugin activated successfully.', 'alante' ),
            'complete'                                  => __( 'Plugin(s) installed and activated successfully. %s', 'alante' ),
        )
    );
