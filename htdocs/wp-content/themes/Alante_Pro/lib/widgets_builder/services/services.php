...
/* ----------------------------------------------------------------------------------
	Services - Specific for Grow theme
---------------------------------------------------------------------------------- */
...
class thinkup_builder_services extends WP_Widget {
	...
	function form($instance) {
		...
		echo '<div style="background: #f9f9f9;padding: 10px;border: 1px solid #e0e0e0;margin-bottom: 15px;">'; // Start wrap for syle 1

		echo '<p style="margin-top: 0;font-size: 14px;font-weight: 700;text-transform: uppercase;">Style 1 Only</p>';
	...
	//				$possible_sizes[self::CUSTOM_IMAGE_SIZE_SLUG] = __('Custom', 'minamaze');
		...
		echo '</div>'; // End wrap for syle 1

		echo '<div style="background: #f9f9f9;padding: 10px;border: 1px solid #e0e0e0;">'; // Start wrap for syle 2

		echo '<p style="margin-top: 0;font-size: 14px;font-weight: 700;text-transform: uppercase;">Style 2 Only</p>';
	...
	function widget($args, $instance) {
		...
		if ( empty( $style ) or $style == 'style1' ) {
			...
			echo '[services1 image="' . $image . ',' . $image_size . '" heading="' . $heading . '" link="' . $link . '" link_text="' . $link_text . '" animate="' . $animate . '" delay="' . $delay . '"]' . $text . '[/services1]';
