...
class thinkup_builder_itemportfoliotheme extends WP_Widget {
	...
	function form($instance) {
		...
		echo '<p><label for="' . $this->get_field_id('toggle_details') . '" style="display: inline-block;width: 150px;" >Toggle Project Tags:</label>
...
/*		echo '<p><label for="' . $this->get_field_id('content_style') . '" style="display: inline-block;width: 150px;" >Content Style:</label>
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[item_portfolio id="' . $post_id . '" link_icon="' . $link_icon . '" lightbox_icon="' . $lightbox_icon . '" title="' . $toggle_title . '" tags="' . $toggle_details . '" style="' . $content_style . '" size="' . $size . '"]' );
