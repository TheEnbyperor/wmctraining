	...
	function widget($args, $instance) {
		...
		if ( empty( $icon_animate ) or $icon_animate == 'none' ) {
			if ( $icon_style == 'style1' ) {
				echo '[font_full1 title="' . $icon_title . '" link="' . $icon_link . '" button="' . $icon_button . '" icon="' . $icon_icon . '" color="' . $icon_color . '" size="' . $icon_size . '" spin="off"]' . $icon_content . '[/font_full1]';
			} else if ( $icon_style == 'style2' ) {
				echo '[font_full2 title="' . $icon_title . '" link="' . $icon_link . '" button="' . $icon_button . '" icon="' . $icon_icon . '" color="' . $icon_color . '" size="' . $icon_size . '" spin="off"]' . $icon_content . '[/font_full2]';
			}
		} else  {
