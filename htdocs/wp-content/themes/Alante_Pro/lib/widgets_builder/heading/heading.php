...
class thinkup_builder_headingtheme extends WP_Widget {
	...
	function form($instance) {
		...
		echo '</select>',
		 ...
		 echo '<p><label for="' . $this->get_field_id('heading_align') . '" style="display: inline-block;width: 150px;" >Heading Alignment:</label>
			<select name="' . $this->get_field_name('heading_align') . '" id="' . $this->get_field_id('heading_align') . '" style="display: inline-block;width: 200px;margin: 0;" >';
			echo '<option '; ?><?php if($heading_align == "default") { echo "selected"; } ?><?php echo ' value="default">Default</option>';
			echo '<option '; ?><?php if($heading_align == "left") { echo "selected"; } ?><?php echo ' value="left">Left</option>';
			echo '<option '; ?><?php if($heading_align == "center") { echo "selected"; } ?><?php echo ' value="center">Center</option>';
			echo '<option '; ?><?php if($heading_align == "right") { echo "selected"; } ?><?php echo ' value="right">Right</option>';
		echo '</select>',
			 '</p>';
	...
	function update($new_instance, $old_instance) {
		...
		$instance['heading_align']     = $new_instance['heading_align'];
	...
	function widget($args, $instance) {
		...
		if ( ! empty( $heading_text ) ) {
			...
			if ( $heading_underline == 'on' ) {
				$class_underline = ' style5';
			}

			// Determing whether text needs to be aligned
			...
			echo $animate_start;
				echo '<div class="customtitle' . $class_underline . $class_align . '">';
