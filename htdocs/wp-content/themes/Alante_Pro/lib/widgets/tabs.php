...
if ( ! class_exists( 'thinkup_widget_tabs' ) ) {
	class thinkup_widget_tabs extends WP_Widget {
		...
		function form($instance) {
			...
			echo '<p><label for="' . $this->get_field_id('title') . '">Title: <input class="widefat" id="' . $this->get_field_id('title') . '" name="' . $this->get_field_name('title') . '" type="text" value="' . attribute_escape($title) . '" style="width: 95px;margin-left: 98px;" /></label></p>';
					
			echo '<p><label for="' . $this->get_field_id('postcount') . '">Number of posts: <input class="widefat" id="' . $this->get_field_id('postcount') . '" name="' . $this->get_field_name('postcount') . '" type="text" value="' . attribute_escape($postcount) . '" style="width: 106px;margin-left: 20px;" /></label></p>';
		...
		global $post;
			...
			echo	'<ul class="nav nav-tabs">',
						'<li class="active"><a href="#widgetrecent-' . $current_instance_id . '" data-toggle="tab"><h3 class="widget-title">' . __( 'Recent', 'alante' ) . '</h3></a></li>',
						'<li><a href="#widgetpopular-' . $current_instance_id . '" data-toggle="tab"><h3 class="widget-title">' . __( 'Popular', 'alante' ) . '</h3></a></li>',
					'</ul>';
