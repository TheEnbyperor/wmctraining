...
<?php
    ...
    $displayGrWrapBlock    = ($grRegisterAr != 1)?"block":"none";
...
<input type="hidden" id="grRegisterAr" value="<?php echo $grRegisterAr?>" />
    ...
    <div class="grWrap" style="display:<?php echo $displayGrWrapBlock?>;">
        <div class="grContent">
            ...
            <div class="ConnectBlock" id="loaderBlock" style="min-height:220px;display:<?php echo $displayLoaderBlock?>;">
            ...
            <div class="ConnectBlock" id="registerBlock" style="display:<?php echo $displayRegisterBlock?>;">
                ...
                <div class="modal fade js-loading-bar" style="background:rgba(51, 51, 51, 0.7); display:none;">
            ...
            <div class="ConnectBlock" id="loginBlock" style="display:<?php echo $displayLoginBlock?>;">
            ...
            <section class="gr_400_section" style="display:none">
    ...
    <div class="ConnectBlock" id="settingBlock" style="display:<?php echo $displaySettingBlock?>;">
       <!-- <div class="grHead">
            <h1><b>Gratis</b>faction</h1>
        </div>
       -->
        <iframe src="<?php echo $frame_url?>" id='frameSetting' frameborder="0" height="550" width='100%' scrolling="auto" ></iframe>
    </div>
    <input type="hidden" name="raffd" id="raffd" value="" />
    <script src="//res.cloudinary.com/appsmav/raw/upload/live/js/iframeResizer.min.js"></script>
    <script src="//appsmav.com/raffd.js"></script>
</div>