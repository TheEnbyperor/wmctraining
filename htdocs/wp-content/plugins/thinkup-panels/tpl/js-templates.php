		...
		<div class="so-panels-welcome-message">
			<div class="so-message-wrapper">
				...
				echo preg_replace(
					...
					__("Add a 1{widget}, 2{row} or 3{prebuilt layout} to get started.", 'siteorigin-panels')
				);
				?>
			</div>
		</div>
...
<script type="text/template" id="siteorigin-panels-dialog-widgets-widget">
	<li class="widget-type {{%= id %}}"><?php // ThinkUpThemes customization - allows id to be added to <li> items in widets list. ?>
