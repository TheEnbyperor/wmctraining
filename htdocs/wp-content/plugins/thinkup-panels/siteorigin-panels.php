...
//	echo '>';
	...
	foreach ( $grids as $gi => $cells ) {
		...
		// START -  ThinkUpThemes customization - Add custom row classes
		$grid_classes_custom = $panels_data['grids'][$gi]['style']['thinkup_rowGridClass'];		
		if( ! empty( $grid_classes_custom ) ) {
			array_push( $grid_classes, $grid_classes_custom );
		}
		// END -  ThinkUpThemes customization
